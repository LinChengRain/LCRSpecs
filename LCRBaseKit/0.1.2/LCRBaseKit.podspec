...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/LinChengRain/LCRBaseKit'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'LinChengRain' => 'yuchanglinlin@163.com' }
  s.source           = { :git => 'https://github.com/LinChengRain/LCRBaseKit.git', :tag => s.version.to_s }
  ...
  s.dependency 'LCRExtensionSwift', '~> 0.1.13'
